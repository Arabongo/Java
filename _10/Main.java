...
public class Main {
    ...
    private static void exercise2() {
        ...
        boolean fancyShoe = true;
        boolean ageToEnter = age>18;
        boolean moneyEntryCondition = eurosInPocket>eurosForEntry;

        if(fancyShoe && (ageToEnter && moneyEntryCondition)) {
    ...
    private static void exercise3() {
        ...
        double percentage = (ourTestScore*100)/maxTestScore;
