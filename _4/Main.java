...
public class Main {
    ...
    private static void exercise2() {
        ...
        char nameInitial = 'E';
        int age = 26;
        System.out.println("My initial is "+nameInitial+ " and my age is "+age);
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        //set a boolean variable hasEatenLunch
        boolean hasEatenLunch = false;
        //set the cost of the lunch in another variable
        double lunchCost = 5.99;
        //print two line: the first whit the cost of the lunch and the second with
        // the answer at the question "Had I lunch?"
