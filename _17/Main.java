...
public class Main {
    ...
    private static void exercise1() {
        ...
        long newBankAccount = myBankBalanceEuro + questionableFundsEuro;
    ...
    public static void exercise3() {
        ...
        LocalDate localDate = LocalDate.of(2023, Month.MARCH, 16);
        LocalDate localDate1= LocalDate.of(2023, Month.FEBRUARY,20);
