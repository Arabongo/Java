...
public class Main {
    ...
    public static void exercise2() {
        ...
        menuPrices.add(7.99);
        menuPrices.add(2.99);
        System.out.println("In the menu we have: "+menuItems.get(0)+" at "+menuPrices.get(0)+" and "+menuItems.get(1)+" at "+menuPrices.get(1));
    }
    ...
    public static void exercise3() {
        ...
        System.out.println("the sum is: "+sumItems);
