...
public class Main {
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        boolean isSandwich = mealType.toLowerCase().equals("sandwich");
        boolean isSoup = mealType.toLowerCase().equals("soup");
        if (isSandwich) {
