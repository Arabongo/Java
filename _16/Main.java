...
public class Main {
     ...
     *
     */
    private static String celsiusToFar(double celsius) {

        double fahrenheit = ((celsius * 9) / 5) + 32;
        String res = celsius + " Celsius is " + fahrenheit + " fahrenheit";
        return res;
    }
    private static void exercise1() {
        System.out.println("Exercise 1:");
        // Put this into a function
        String conversionDescription = celsiusToFar(30);
     ...
     */
    private static String printingName(String name){
    ...
    private static void exercise2() {
        ...
        for (String name : names) {
            System.out.println(printingName(name));
        }
    }
    ...
    private static String printVariables(){
        double myLunchPrice = 5.99;
        String lunchType = "sandwich";
        String description = "Nice big sandwich";
        int weightInGrams = 500;

        return lunchType+ " cost "+ myLunchPrice+ " and is a very "+ description+ " of "+ weightInGrams+ " grams" ;
    }
}
