...
public class Main {
    ...
    private static void exercise1() {
        ...
        // in ex 1a (currentinvestmentValueEuros < 100_000)
        ...
        //this for ex 1.a
        // System.out.println("We finally reached 100k" + " " +currentInvestmentValueEuros);
    }
    ...
    private static void exercise2() {
        ...
        while (remainingPoundsToSell>0){
            ...
            if(exchangeRate>poundToEuroExchangeRate){
               int poundToSell =Math.min(maxPoundsToSellPerDay,remainingPoundsToSell);
                double eurosToSell = poundToSell / exchangeRate;
                remainingPoundsToSell -= poundToSell;
     ...
     * A1:we can use for each because we have a defined list
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2:we use a for i because we have a defined list of number so we use index
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3:we use a while loop because we don't know all the name in the database
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4:we can use a while loop beacuse we want to check a condition before the loop
     */
}}
